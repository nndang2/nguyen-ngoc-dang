...
$name		= postIndex("name");
$sm 		= postIndex("submit");
$info		= postIndex("thong_tin");

// xu ly thong tin gui len
$infoWithoutHTMLTags = strip_tags($info);
$infoReplaceBreakToBrTags = NL2br($info);
$infoAddSlashBefore = preg_replace("/'/","\\'",$info);
$infoWithoutSlashBefore = preg_replace("/\\\'/","'",$info);
echo $infoWithoutSlashBefore;
...
<table  align="center">
	...
	<tr><td>Thong tin</td><td><textarea name="thong_tin" cols="20" rows="5" placeholder="Nhap thong tin"><?php echo $info;?></textarea></td></tr>
    	...
    	<?php 
			if ($err !="") echo $err;
			else
			  {
				...
				echo "Mật khẩu đã mã hóa Md5 va SHA1:".sha1(md5($password1)) ."<br>";
				echo "Mật khẩu đã mã hóa SHA1 va MD5:".md5(sha1($password1)) ."<br>";
				echo "Họ tên: ". ucwords($name) ."<br>";  
				echo "Thong tin:<br />";
				echo "Da xoa cac the html: ".$infoWithoutHTMLTags ."<br>";
				echo htmlentities("Thay ki tu xuong hang bang the <br />").$infoReplaceBreakToBrTags ."<br>";
				echo "Them dau \\ vao truoc dau ': ".$infoAddSlashBefore ."<br>";
				echo "Bo dau \\ o truoc dau ': ".$infoWithoutSlashBefore ."<br>";
			}
		?>
    </div>
    <?php
	ádasdasdahskldjaskldjklajflkjsdlkgjaklsdjglkadfjglkjlkgj
}
?>
</body>
</html>
